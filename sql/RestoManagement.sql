...
-- Started on 2024-01-05 20:57:17
...
ALTER SEQUENCE public.transaction_detail_menu_id_seq OWNED BY public.transaction_detail_menu.id;
...
ALTER SEQUENCE public.transaction_detail_seat_id_seq OWNED BY public.transaction_detail_seat.id;
...
--
-- TOC entry 3241 (class 2604 OID 16870)
...
--
-- TOC entry 3414 (class 0 OID 16688)
-- Dependencies: 216
...
--
-- TOC entry 3417 (class 0 OID 16744)
-- Dependencies: 219
...
--
-- TOC entry 3424 (class 0 OID 16768)
-- Dependencies: 226
...
--
-- TOC entry 3419 (class 0 OID 16758)
-- Dependencies: 221
...
--
-- TOC entry 3429 (class 0 OID 16799)
-- Dependencies: 231
...
--
-- TOC entry 3427 (class 0 OID 16791)
-- Dependencies: 229
...
COPY public.transaction_detail_menu (id, menu_id, quantity) FROM stdin;
\.


--
-- TOC entry 3438 (class 0 OID 16836)
-- Dependencies: 240
-- Data for Name: transaction_detail_seat; Type: TABLE DATA; Schema: public; Owner: kuitkatnekat
--

COPY public.transaction_detail_seat (id, seat_type_id, person) FROM stdin;
\.


--
-- TOC entry 3434 (class 0 OID 16809)
-- Dependencies: 236
...
SELECT pg_catalog.setval('public.seat_type_id_seq', 3, true);
...
SELECT pg_catalog.setval('public.transaction_detail_menu_id_seq', 1, false);
...
SELECT pg_catalog.setval('public.transaction_detail_seat_id_seq', 1, false);
...
SELECT pg_catalog.setval('public.transaction_header_id_seq', 1, false);
...
--
-- TOC entry 3243 (class 2606 OID 16693)
...
--
-- TOC entry 3245 (class 2606 OID 16750)
...
--
-- TOC entry 3249 (class 2606 OID 16778)
...
--
-- TOC entry 3253 (class 2606 OID 16804)
...
--
-- TOC entry 3251 (class 2606 OID 16797)
...
--
-- TOC entry 3259 (class 2606 OID 16872)
...
-- Name: transaction_detail_seat transaction_detail_seat_pkey; Type: CONSTRAINT; Schema: public; Owner: kuitkatnekat
--

ALTER TABLE ONLY public.transaction_detail_seat
    ADD CONSTRAINT transaction_detail_seat_pkey PRIMARY KEY (id);


--
-- TOC entry 3255 (class 2606 OID 16817)
...
--
-- TOC entry 3262 (class 2606 OID 16779)
...
--
-- TOC entry 3268 (class 2606 OID 16873)
-- Name: transaction_detail_menu transaction_detail_menu_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: kuitkatnekat
--

ALTER TABLE ONLY public.transaction_detail_menu
    ADD CONSTRAINT transaction_detail_menu_id_fkey FOREIGN KEY (id) REFERENCES public.transaction_header(id) ON UPDATE CASCADE ON DELETE CASCADE;
...
--
-- TOC entry 3266 (class 2606 OID 16844)
-- Name: transaction_detail_seat transaction_detail_seat_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: kuitkatnekat
--

ALTER TABLE ONLY public.transaction_detail_seat
    ADD CONSTRAINT transaction_detail_seat_id_fkey FOREIGN KEY (id) REFERENCES public.transaction_header(id) ON UPDATE CASCADE ON DELETE CASCADE;


--
-- TOC entry 3267 (class 2606 OID 16849)
...
--
-- TOC entry 3263 (class 2606 OID 16818)
...
--
-- TOC entry 3264 (class 2606 OID 16823)
...
--
-- TOC entry 3265 (class 2606 OID 16828)
...
-- Completed on 2024-01-05 20:57:26
